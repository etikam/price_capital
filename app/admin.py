...
from .models import Contact, PorteurProject, Project, ProjectCategory, ProjectType, Realisation, ValidatedProject
...
class ValidatedProjectAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Objectifs et Livrables", {"fields": ("general_objective", "specific_objectives", "deliverables")}),
        ("Détails supplémentaires", {"fields": ("target_audience", "key_partners", "additional_details")}),
        ("Budget et Localisation", {"fields": ("goal", "current_funding", "currency", "location", "gains")}),
        ("Documents et Images", {"fields": ("documents", "image")}),
        ("Validation", {"fields": ("is_approved", "approved_at", "reformulated_by")}),
